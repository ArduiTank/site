		...
		<div class="hero-body" id="actu">
			<div class="container">
				...
				<div class="content collapse is-medium">
					...
					<p style="padding: 0 18px 2rem 18px;">L'occasion rêvée pour séparer notre fichier principal avec un include de header et des fichier CSS (plus tout intégré dans un même fichier).</p>
				</div>
